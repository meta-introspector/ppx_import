...
and  open_infos = Ppxlib__.Import.open_infos [@@deriving yojson_of]]
and  include_infos = Ppxlib__.Import.include_infos [@@deriving yojson_of]]
and  class_infos = Ppxlib__.Import.class_infos [@@deriving yojson_of]]
 *)
let main () = ()
